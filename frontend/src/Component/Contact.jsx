...
const Contact = () => {
    ...
    const sumbitForm = async (e) => {
        ...
        try {
            const res = await axios.post("https://installationworld.yaytech.in/api/v1/contact/createcontact", detail)
                                ...
                                <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div class="bg-white rounded-lg p-6 block">
                                        ...
                                        <a href="javascript:;" class="flex items-center">
                                            ...
                                            <h5 class="text-black text-base font-normal leading-6 ml-5">F 48 Shopping  Centre 1 Mansarovar Garden New Delhi 110015</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
