...
const Header = () => {
    ...
    return (
        <div className={`${locaion.pathname === '/admindashboard' ? 'hidden' : ''}`}>
                    ...
                    <ul className='flex md:flex-row flex-col md:items-center  items-start gap-2 md:gap-10 pt-4 pl-3 md:pl-0 '>
                        ...
                        </li>
                        {
                            isadmin ?
                                (
                                    <li>
                                        <Link to={"/admindashboard"} className='font-bold text-black hover:text-[#fb823f] duration-300' onClick={() => setopen(!open)}>Dashbord</Link>
                                    </li>
                                )
                                : ""
                    }
