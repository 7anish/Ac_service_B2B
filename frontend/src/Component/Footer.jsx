                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        ...
                        <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                            <a href="javascript:;" className="w-9 h-9 duration-300 rounded-full bg-gray-700 flex justify-center items-center hover:bg-orange-600">
                            ...
                            <a href="javascript:;" className="w-9 h-9 duration-300 rounded-full bg-gray-700 flex justify-center items-center hover:bg-orange-600">
                                <svg className="w-[1.25rem] h-[1.125rem] text-gray-300 font-medium" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="javascript:;" className="w-9 h-9 duration-300 rounded-full bg-gray-700 flex justify-center items-center hover:bg-orange-600">
                                <svg className="w-[1rem] h-[1rem] text-gray-300 font-medium" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="javascript:;" className="w-9 h-9 duration-300 rounded-full bg-gray-700 flex justify-center items-center hover:bg-orange-600">
                                <svg className="w-[1.25rem] h-[0.875rem] text-gray-300 font-medium" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
